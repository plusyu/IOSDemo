...
- (NSString *)tempPath {
    ...
    if (self.targetPath) {
        NSString *md5URLString = [[self class] md5StringForString:urlStr];
        NSString *cacheFolder =  [[self class] cacheFolder];
        tempPath = [cacheFolder stringByAppendingPathComponent:md5URLString];
    }
