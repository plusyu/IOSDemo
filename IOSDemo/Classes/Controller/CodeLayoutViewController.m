...
//    [self example_6];
     ...
     NSLog(@"self:%f",self.redView.frame.size.width);
}
...
- (void)example_2
{
    ...
    NSArray *yellow_constraint_H = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[yellowView(100)]"
                                                                           options:0
                                                                           metrics:nil
                                                                             views:viewsDictionary];
